# JMEditorEnvironment
A flexible editor environment that runs on JMgui and JMGraphics.
...
These gui sections can be placed either at spacific pixel coordinates, or alligned to guides that the user can manimpulate within defined limits.
...
A built in serialization system allows all SimEnvironments to be saved and loaded from files with a customizable file extension.
